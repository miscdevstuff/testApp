    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/miscdevstuff/testapp/")
                ...
                developers {
                    developer {
                        id.set("miscdevstuff")
                        name.set("miscdevstuff")
                    }
                }
                scm {
                    connection.set("scm:git:git://github.com/miscdevstuff/testapp.git")
                    developerConnection.set("scm:git:ssh://github.com/miscdevstuff/testapp.git")
                    url.set("https://github.com/miscdevstuff/testapp/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/miscdevstuff/testapp/issues")
                }
            }
        }
    }
